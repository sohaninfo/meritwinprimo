...
<span class="cstat-no" title="statement not covered">        if (tries-- &gt; 0) <span class="cstat-no"
                                                                                       title="statement not covered">return _getUniqueName();</span></span>
&nbsp;
...
&nbsp;
    ...
    fs.open(name, CREATE_FLAGS, opts.mode || FILE_MODE, function _fileCreated(err, fd) {
      <span class="missing-if-branch" title="if path not taken">I</span>if (err) <span class="cstat-no"
                                                                                       title="statement not covered">return cb(err);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no"
      title="statement not covered">    for (var i = 0, length = files.length; i &lt; length; i++) {</span>
<span class="cstat-no" title="statement not covered">      var</span>
...
<span class="cstat-no"
      title="statement not covered">      if (e.errno != -_c.EBADF &amp;&amp; e.errno != -_c.ENOENT) {</span>
...
&nbsp;
  return function _cleanupCallback() {
    <span class="missing-if-branch" title="if path not taken">I</span>if (called) <span class="cstat-no"
...
<span class="cstat-no" title="statement not covered">  process.addListener('uncaughtException', <span class="fstat-no"
                                                                                                      title="function not covered">function _uncaughtExceptionThrown(err) {</span></span>
...
<div class='footer quiet pad2 space-top1 center small'>
    Code coverage
    generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Sep 20 2016 12:42:12 GMT+0200
    (CEST)
</div>
</div>
